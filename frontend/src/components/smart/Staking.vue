      ...
      >
        <div class="reward-claim-inner-wrapper">
          ...
          <p class="center-text selectable">
            {{ currentRewardEarned.toFixed(18) }} PGS
          </p>
      ...
      <div class="stakePage medium-dark-bg">
        ...
        >
          ...
          <span class="gold-text" v-else-if="canStakeUnclaimedRewards">
            Stake all of unclaimed rewards ({{ formattedSkillRewards }} PGS)
          </span>
          <span class="gold-text" v-else>
...
export default {
  ...
  computed: {
    ...
    stakingTokenName() {
      return this.stakeType === 'skill' || this.stakeType === 'skill2' ? 'PGS' : 'PGS-WBNB';
    },
