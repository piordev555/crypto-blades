    ...
    >
      <div class="starter-panel">
        ...
        <div class="instructions-list">
          <p>
            Get started in less than 10 minutes! To recruit your first character you need {{ recruitCost }} PGS and .001 BNB for gas. You will also need .0015
            BNB to do your first few battles, but don't worry, you earn the battle fees back in PGS rewards immediately!
          </p>
          <ul class="unstyled-list">
            <li>1. Buying BNB with fiat: <a href="https://youtu.be/6-sUDUE2RPA" target="_blank" rel="noopener noreferrer">Watch Video</a></li>
            <li>
              2. Once you have BNB, go to ApeSwap to obtain Pegasus tokens:<br />
              <a v-bind:href="`${getExchangeUrl}`" target="_blank">Trade PGS/BNB</a>
            </li>
            <li>
              3. Follow this tutorial to swap BNB for PGS: <a href="https://youtu.be/_zitrvJ7Hl4" target="_blank" rel="noopener noreferrer">Watch Video</a>
            </li>
            <li>
