<template>
  <div class="body main-font">
    ...
    <div v-if="ownCharacters.length === 0" class="blank-slate">
      ...
      <big-button
        class="button"
        :mainText="`Recruit character for ${recruitCost} PGS`"
        :disabled="!canRecruit()"
      ...
      <div v-if="formatSkill() < recruitCost" >
        <br>
        You can buy more PGS from <a v-bind:href="`${getExchangeUrl}`" target="_blank">here</a>.
      </div>
    </div>
        ...
        <div v-if="ownCharacters.length > 0">
          <div class="d-flex justify-content-space-between">
            ...
            <b-button
              ...
              Recruit ({{ recruitCost }} NON-IGO PGS) <i class="fas fa-plus"></i>
            </b-button>
          </div>
