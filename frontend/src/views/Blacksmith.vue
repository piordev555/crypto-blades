    ...
    <b-tabs justified>
      <b-tab title="Weapons">
        <div class="blank-slate" v-if="ownWeapons.length === 0">
          ...
          <big-button
            class="button"
            :mainText="`Forge sword for ${forgeCost} PGS`"
            @click="onForgeWeapon"
          />
        </div>
            ...
            <div class="d-flex justify-content-space-between">
              ...
              <div class="d-flex justify-content-flex-end ml-auto">
                ...
                <b-button
                  ...
                  <span v-if="!disableForge" class="gtag-link-others" tagname="forge_weapon">Forge x1 ({{ forgeCost }} PGS) <i class="fas fa-plus"></i></span>
                </b-button>
                ...
                <b-button
                  ...
                  <span v-if="disableForge">Cooling forge...</span>
                  <span v-if="!disableForge" class="gtag-link-others" tagname="forge_weapon">Forge x10 ({{ forgeCost*10 }} PGS)
                  ...
                  <b-checkbox
                    ...
                    <span v-if="disableUseStakedForForge"> <b>Not enough staked PGS<br></b></span>
                ...
                <b-modal hide-footer ref="forge-details-modal" title="Forge Percentages">
                  <div>
                    5* @ 1% chance. Estimated cost {{Number.parseFloat(forgeCost * (1/0.01)).toFixed(2)}} PGS.
                  </div>
                  <div>
                    4*+ @ 6% chance. Estimated cost {{Number.parseFloat(forgeCost * (1/0.06)).toFixed(2)}} PGS.
                  </div>
                  <div>
                    3*+ @ 21% chance. Estimated cost {{Number.parseFloat(forgeCost * (1/0.21)).toFixed(2)}} PGS.
                  </div>
                  <div>
                    2*+ @ 56% chance. Estimated cost {{Number.parseFloat(forgeCost * (1/0.56)).toFixed(2)}} PGS.
                  </div>
                  <div>
                    1* @ 100% chance.
                  </div>
                    ...
                    <b-button
                      ...
                      v-tooltip="'Forge a new weapon'">
                        <span v-if="!disableForge" class="gtag-link-others" tagname="forge_weapon">
                          Forge ({{Number.parseFloat(forgeCost * this.chosenElementFee).toFixed(2)}} PGS)
                        </span>
                    </b-button>
                    <b-button
                      ...
                      v-tooltip="'Forge 10 new weapons'">
                        <span v-if="!disableForge" class="gtag-link-others" tagname="forge_weapon">
                          Forge ({{Number.parseFloat(forgeCost * this.chosenElementFee * 10).toFixed(2)}} PGS)
                        </span>
                    </b-button>
                  </div>
                </b-modal>
            ...
            <div class="d-flex justify-content-space-between">
              ...
              <div class="d-flex justify-content-flex-end ml-auto">
                <b-button
                  ...
                  <br>
                  ({{burnCost * burnWeaponIds.length }} PGS)
                </b-button>
                <b-button
                        variant="primary"
                        tagname="confirm_forge_weapon"
      ...
      <b-tab>
        <template #title>
          Equipment <b-icon-question-circle class="centered-icon" scale="0.8"
            v-tooltip.bottom="`You can buy a shield in the PEGASUS Shop tab on the market page and loot other NFTs from Raids!`"/>
        </template>
        <div class="row mt-3">
          <div class="col">
            <div class="d-flex justify-content-space-between">
