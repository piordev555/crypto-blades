              ...
              <div class="col-4 col-md-3 col-lg-2 mb-2">
                ...
                <b-modal class="centered-modal" ref="listing-setup-modal"
                  ...
                  <b-form-input type="number" :max="10000"
                    class="modal-input" v-model="listingSellPrice" placeholder="Sell Price (PGS)" />
...
export default Vue.extend({
  ...
  methods: {
    ...
    async addListingForNft() {
      ...
      this.selectedNftId = null;
      this.waitingMarketOutcome = false;
      this.marketOutcome = `Successfully listed ${this.activeType} ${results.nftID} for ${this.convertWeiToSkill(results.price)} PGS`
    ...
    async updateNftListingPrice() {
      ...
      this.selectedNftId = null;
      this.waitingMarketOutcome = false;
      this.marketOutcome = `Successfully changed price for ${this.activeType} ${results.nftID} to ${this.convertWeiToSkill(results.newPrice)} PGS`;
    },
    ...
    async purchaseNft() {
      ...
      this.marketOutcome = 'Successfully purchased '
        +this.activeType+' '+results.nftID+' for '+this.convertWeiToSkill(results.price)+' PGS'
          +' from '+results.seller;
    },
